...
Shader "Crest/Underwater Curtain"
{
	...
	SubShader
	{
		Tags{ "RenderPipeline" = "UniversalPipeline" "Queue" = "Geometry+510" "IgnoreProjector" = "True" "RenderType" = "Opaque" }
		...
		Pass
		{
			...
			#pragma multi_compile_local __ _SHADOWS_ON
				...
				#include "../Helpers/URP/Lighting.hlsl"
			#else
			...
			half4 Frag(Varyings input) : SV_Target
			{
				...
				const float pixelZ = CrestLinearEyeDepth(input.positionCS.z);
				...
				const half3 lightCol = mainLight.color;
#else
